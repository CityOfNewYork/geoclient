...
{{- /*
name defines a template for the name of the geoclient chart.
...
Usage: 'name: "{{- template "geoclient.name" . -}}"'
*/ -}}
{{- define "geoclient.name"}}
...
the release name and the geoclient chart name.
...
Usage: 'name: "{{- template "geoclient.fullname" . -}}"'
*/ -}}
{{- define "geoclient.fullname"}}
{{- $global := default (dict) .Values.global -}}
...
{{- /*
geoclient.labels.standard prints the standard geoclient Helm labels.

The standard labels are frequently used in metadata.
*/ -}}
{{- define "geoclient.labels.standard" -}}
app: {{ template "geoclient.name" . }}
chart: {{ template "geoclient.chartref" . }}
heritage: {{ .Release.Service | quote }}
release: {{ .Release.Name | quote }}
{{- end -}}

{{- /*
geoclient.chartref prints a chart name and version.
...
*/}}
{{- define "geoclient.volumePermissions.image" -}}
...
*/}}
{{- define "geoclient.imagePullSecrets" -}}
{{/*
Helm 2.11 supports the assignment of a value to a variable defined in a different scope,
