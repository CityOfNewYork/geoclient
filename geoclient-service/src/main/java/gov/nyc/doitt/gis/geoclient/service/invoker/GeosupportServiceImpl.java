...
public class GeosupportServiceImpl implements GeosupportService
{
    ...
    @Override
    public Map<String, Object> callFunction1B(final String houseNumber, final String street, final String borough, final String zip)
    {
    ...
    @Override
    public Map<String, Object> callFunction3(final String onStreet, final String boroughOnStreet, final String crossStreetOne,
            final String boroughCrossStreetOne, final String crossStreetTwo, final String boroughCrossStreetTwo, final String compassDirection)
    {
    ...
    {
        final Function function = serviceConfiguration.geosupportFunction(clientParams.get(GEOSUPPORT_FUNCTION_CODE).toString());
    ...
    {
        return new DocumentationConfigurer(serviceConfiguration.geosupportConfiguration(), serviceConfiguration.latLongEnhancer()).configureDocumentation();
    }
