...
public class SimilarNamesTaskBuilder extends TaskBuilderSupport
{
			...
			String similarName)
	{
		...
		if (search.responseMessageAppliesTo(crossStreetOne) && searchPolicy.isSimilarName(crossStreetOne, similarName))
		{
		...
		if (search.responseMessageAppliesTo(crossStreetTwo) && searchPolicy.isSimilarName(crossStreetTwo, similarName))
		{
