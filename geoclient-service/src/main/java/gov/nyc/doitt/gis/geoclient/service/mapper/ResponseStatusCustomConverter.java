...
public class ResponseStatusCustomConverter implements CustomConverter {
    ...
    private void convertToMapOfGeosupportReturnCodeOne(GeosupportReturnCode returnCodeOne,
    ...
    private void convertToMapOfGeosupportReturnCodeTwo(GeosupportReturnCode returnCodeTwo,
	    Map<String, Object> dest) {
    ...
    private void convertToMapOfSimilarNames(List<String> similarNames,
	    Map<String, Object> dest) {
	int i = 1;
