...
public final class ImageToMap {
	 ...
	 *            A distance value in pixels to be converted to map units.
	 */
	...
	public static final MapEnvelope convertEnvelope(ImageEnvelope userEnv, MapEnvelope mapEnv, int imgHeight, int imgWidth) {
	...
	/**
	 * This method assumes that parameter p is a DoittPoint in image coordinates
	 ...
	 * 
	 * @param imagePoint
	 *            The DoittPoint to convert from image coordinates to map
	 *            coordinates.
	 * @param mapEnv
	...
	public static final PointGeometry convertPoint(PointGeometry imagePoint, MapEnvelope mapEnv, int imgHeight, int imgWidth) {
