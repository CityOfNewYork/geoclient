...
public final class MapToImage {
    ...
    /**
     * This method assumes that parameter p is a DoittPoint in map coordinates and
    ...
    /**
     * @param allMapPoints List of map points where x and y are separated by commas
     *                     and each point x/y pair is separated by a space.
     * @return List of image points where x and y are separated by commas and each
     *         point x/y pair is separated by a space.
     */
    public static final String convertAllPoints(String allMapPoints, String envMinXString, String envMinYString,
            String envMaxXString, String envMaxYString, String imgHeightString, String imgWidthString) {
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            if (idx != -1) {
                ...
                ImagePoint imagePoint = getImagePoint(mapX, mapY, envMinXString, envMinYString, envMaxXString,
                        envMaxYString, imgHeightString, imgWidthString);
    ...
    public static final double convertPointX(String mapX, String mapY, String envMinX, String envMinY, String envMaxX,
            String envMaxY, String imgHeight, String imgWidth) {
        ImagePoint imgPoint = getImagePoint(mapX, mapY, envMinX, envMinY, envMaxX, envMaxY, imgHeight, imgWidth);
        return imgPoint.getX();
    }

    public static final double convertPointX(double mapX, double mapY, double envMinX, double envMinY, double envMaxX,
            double envMaxY, int imgHeight, int imgWidth) {
        ImagePoint imgPoint = getImagePoint(mapX, mapY, envMinX, envMinY, envMaxX, envMaxY, imgHeight, imgWidth);
        return imgPoint.getX();
    }

    public static final double convertPointY(String mapX, String mapY, String envMinX, String envMinY, String envMaxX,
            String envMaxY, String imgHeight, String imgWidth) {
        ImagePoint imgPoint = getImagePoint(mapX, mapY, envMinX, envMinY, envMaxX, envMaxY, imgHeight, imgWidth);
        return imgPoint.getY();
    }

    public static final double convertPointY(double mapX, double mapY, double envMinX, double envMinY, double envMaxX,
            double envMaxY, int imgHeight, int imgWidth) {
        ImagePoint imgPoint = getImagePoint(mapX, mapY, envMinX, envMinY, envMaxX, envMaxY, imgHeight, imgWidth);
        return imgPoint.getY();
    }

    private static ImagePoint getImagePoint(String mapXString, String mapYString, String envMinXString,
            String envMinYString, String envMaxXString, String envMaxYString, String imgHeightString,
            String imgWidthString) {
    ...
    private static ImagePoint getImagePoint(double mapX, double mapY, double envMinX, double envMinY, double envMaxX,
            double envMaxY, int imgHeight, int imgWidth) {
