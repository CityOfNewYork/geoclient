...
public class DoittLayer implements Cloneable {
    ...
    /**
     * A boolean value that indicates whether or not this layer will be shown in the
     * map's legend.
     */
    private boolean legend = true;

    /**
     * The maximum relative scale factor at which this DFoittLayer will be drawn on
     * a map.
     */
    private long maxRelativeScaleFactor = -1;

    /**
     * The minimum relative scale factor at which this DFoittLayer will be drawn on
     * a map.
     */
    ...
    /**
     * A boolean value that indicates whether or not this layer will be drawn on the
     * map.
     */
    ...
    /**
     * @param id      The unique id of this layer.
     * @param name    A friendly name for this layer.
     * @param visible A boolean value that indicates whether or not this layer will
     *                be drawn on the map.
     * @param legend  A boolean value that indicates whether or not this layer will
    ...
    /**
     * @return The maximum relative scale factor at which this DFoittLayer will be
     *         drawn on a map.
     */
    ...
    /**
     * @return The minimum relative scale factor at which this DFoittLayer will be
     *         drawn on a map.
     */
    ...
    /**
     * @param relativeScaleFactor A double value representing the relative scale
     *                            factor of a map.
     * @return A boolean value that indicates whether or not this layer will be
     *         drawn on the map at the specified relative scale factor.
     */
    public boolean isVisibleAtScale(double relativeScaleFactor) {
        return isGreaterThanMinScale(relativeScaleFactor) && isLessThanMaxScale(relativeScaleFactor);
    }
    ...
    /**
     * @param maxRelativeScaleFactor The maximum relative scale factor at which this
     *                               DFoittLayer will be drawn on a map.
     */
    ...
    /**
     * @param minRelativeScaleFactor The minimum relative scale factor at which this
     *                               DFoittLayer will be drawn on a map.
     */
    ...
    /**
     * @param visibleAtScale A boolean value that indicates whether or not this
     *                       layer will be drawn on the map at the current map
     *                       scale.
     */
