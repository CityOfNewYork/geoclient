...
public interface Constants {
    /**
     * Use as the direction parameter of the pan method to move the map to the east.
     */
     ...
     */
    static final DoittEnvelope NYC_FULL_EXTENT = new MapEnvelope(NYC_MIN_X, NYC_MIN_Y, NYC_MAX_X, NYC_MAX_Y);
    ...
    /**
     * Use as the direction parameter of the pan method to move the map to the west.
     */
