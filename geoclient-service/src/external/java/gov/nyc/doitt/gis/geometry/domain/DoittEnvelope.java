...
public interface DoittEnvelope extends Cloneable {
    ...
    /**
     * @param lowerLeft A DoittPoint (minX, minY) that is the lower left corner of
     *                  the DoittEnvelope.
     */
    void setLowerLeft(DoittPoint lowerLeft);

    /**
     * @param maxX The maximum x coordinate value of the DoittEnvelope.
     */
    void setMaxX(double maxX);

    /**
     * @param maxY The maximum y coordinate value of the DoittEnvelope.
     */
    void setMaxY(double maxY);

    /**
     * @param minX The minimum x coordinate value of the DoittEnvelope.
     */
    void setMinX(double minX);

    /**
     * @param minY The minimum y coordinate value of the DoittEnvelope.
     */
