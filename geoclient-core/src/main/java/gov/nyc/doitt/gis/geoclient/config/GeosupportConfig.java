...
public class GeosupportConfig {
    ...
    public GeosupportConfig(String configFile, String documentationConfigFile, Geoclient geoclient) {
        ...
        log.info("Loading geoclient's documentation configuration from file {}", documentationConfigFile);
        this.documentationXmlReader = DocumentationXmlReader.fromXml(documentationConfigFile);
        log.info("Successfully loaded file {}", documentationConfigFile);
    ...
    private void init() {
        ...
        for (FunctionConfig functionConfig : this.geoclientXmlReader.getFunctions()) {
            ...
            Registry.addFunctionDocumentation(documentationConfig
                    .document(documentationXmlReader.getFunctionDocumentation(function.getId()), function));
        }
    }
